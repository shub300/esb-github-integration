...
class CreatePlatformInventoryTrailsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('platform_inventory_trails', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('platform_inventory_trails');
    }
}
