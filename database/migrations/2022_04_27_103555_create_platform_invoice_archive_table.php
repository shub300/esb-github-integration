...
class CreatePlatformInvoiceArchiveTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('platform_invoice_archive', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('platform_invoice_archive');
    }
}
