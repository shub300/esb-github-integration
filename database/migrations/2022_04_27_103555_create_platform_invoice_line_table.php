...
class CreatePlatformInvoiceLineTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('platform_invoice_line', function (Blueprint $table) {
            $table->integer('id', true);
            $table->bigInteger('platform_invoice_id')->default(0);
            $table->bigInteger('api_invoice_line_id')->nullable();
            ...
            $table->index(['platform_invoice_id', 'api_invoice_line_id'], 'platform_invoice_id');
        });
    }
    ...
    {
        Schema::dropIfExists('platform_invoice_line');
    }
}
