...
class CreatePlatformOrderAddressTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('platform_order_address', function (Blueprint $table) {
...
');
    ...
    {
        Schema::dropIfExists('platform_order_address');
    }
}
