...
class CreatePlatformOrderLineArchiveTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('platform_order_line_archive', function (Blueprint $table) {
...
tax or tax charge=TAX');
    ...
    {
        Schema::dropIfExists('platform_order_line_archive');
    }
}
