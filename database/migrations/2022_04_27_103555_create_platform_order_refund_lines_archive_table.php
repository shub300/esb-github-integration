...
class CreatePlatformOrderRefundLinesArchiveTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('platform_order_refund_lines_archive', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('platform_order_refund_lines_archive');
    }
}
