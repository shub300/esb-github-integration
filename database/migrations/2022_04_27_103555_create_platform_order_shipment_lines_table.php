...
class CreatePlatformOrderShipmentLinesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('platform_order_shipment_lines', function (Blueprint $table) {
            $table->bigInteger('id', true);
            $table->bigInteger('platform_order_shipment_id')->index('cascade_shipment_line');
    ...
    {
        Schema::dropIfExists('platform_order_shipment_lines');
    }
}
