...
class CreatePlatformOrderTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('platform_order', function (Blueprint $table) {
            ...
            $table->enum('order_type', ['PO', 'SO', 'TO', 'IO', 'SC'])->nullable();
            ...
            $table->boolean('is_fully_synced')->default(false)->comment('after this not updates will happen, set this to 1 if order is full acknowledged');
    ...
    {
        Schema::dropIfExists('platform_order');
    }
}
