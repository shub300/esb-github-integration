...
class CreatePlatformOrderTransactionsArchiveTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('platform_order_transactions_archive', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('platform_order_transactions_archive');
    }
}
