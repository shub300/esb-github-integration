...
!(function (bt) {
    (bt.floatThead = bt.floatThead || {}),
        (bt.floatThead.defaults = {
    ...
    var wt = (function () {
        ...
        mt = (function () {
            for (
                var t = 3, e = document.createElement("b"), o = e.all || [];
                (t = 1 + t),
                    (e.innerHTML =
                        "\x3c!--[if gt IE " + t + "]><i><![endif]--\x3e"),
                    o[0];
    ...
    function St(t) {
        ...
        do {
            if (
                "visible" !==
                window.getComputedStyle(e).getPropertyValue("overflow")
            )
                break;
    ...
    function jt(t) {
        window &&
            ...
            window.console.error("jQuery.floatThead: " + t);
    }
    function zt(t) {
    ...
    function It() {
        ...
        (t.style.cssText =
            "width:100px;height:100px;overflow:scroll!important;position:absolute;top:-9999px;display:block"),
    ...
    function Ht(t, e, o) {
        ...
        if (l && t.css("max-width")) {
            var r = 0;
            o &&
                ((r += parseInt(t.css("borderLeft"), 10)),
    ...
    bt.fn.floatThead = function (t) {
        ...
        if (
            (bt.each(t, function (t, e) {
                t in bt.floatThead.defaults ||
                    !vt.debug ||
                    jt(
                        "Used [" +
                            t +
                            "] key to init plugin, but that param is not an option for the plugin. Valid options are: " +
                            wt.keys(bt.floatThead.defaults).join(", ")
                    );
            }),
            vt.debug)
        ) {
            ...
            1 === parseInt(e[0], 10) &&
                ...
                jt(
                    "jQuery version " +
                        bt.fn.jquery +
                        " detected! This plugin supports 1.8 or better, or 1.7.x with jQuery UI 1.8.24 -> http://jqueryui.com/resources/download/jquery-ui-1.8.24.zip"
                );
        }
        return (
            this.filter(":not(." + vt.floatTableClass + ")").each(function () {
                var e = wt.uniqueId(),
                    m = bt(this);
                ...
                if (0 === d.length || 0 === r.length)
                    return (
                        vt.debug &&
                            (0 === d.length
                                ? jt("The thead element is missing.")
                                : jt("The tbody element is missing.")),
                        m.data("floatThead-lazy", vt),
                ...
                "auto" === vt.position
                    ...
                    : "fixed" === vt.position
                    ? (z = !1)
                    : "absolute" === vt.position
                    ? (z = !0)
                    : vt.debug &&
                      jt(
                          'Invalid value given to "position" option, valid is "fixed", "absolute" and "auto". You passed: ',
                          vt.position
                      ),
                    null == z && (z = L);
                ...
                if (H)
                    var W =
                        "top" ===
                        (I.css("caption-side") || I.attr("align") || "top");
                ...
                b.append(w),
                    m.prepend(u),
                    Ct && (l.append(v), m.append(l)),
                    f.append(c),
                    E.append(f),
                    vt.copyTableClass && f.attr("class", m.attr("class")),
                    f.attr({
                ...
                if (
                    ...
                    "none" === t && (M = !0),
                    f
                        .addClass(vt.floatTableClass)
                        .css({ margin: 0, "border-bottom-width": 0 }),
                    z)
                ) {
                    var O = function (t, e) {
                        ...
                        if (!("relative" === o || "absolute" === o) || e) {
                            ...
                            E.css(r),
                                (n =
                                    t.data("floatThead-containerWrap") ||
                                    t
                                        .wrap(
                                            bt("<div>")
                                                .addClass(vt.floatWrapperClass)
                                                .css({
                                                    position: "relative",
                                                    clear: "both",
                                                })
                                        ...
                                        .parent()),
                                t.data("floatThead-containerWrap", n),
                                (q = !0);
                        }
                        return n;
                    };
                ...
                E.css({
                    ...
                    E.addClass(vt.floatContainerClass),
                    V();
                ...
                function P() {
                    var t = 0;
                    if (
                        (d.children("tr:visible").each(function () {
                ...
                function V() {
                    (y = (wt.isFunction(vt.top) ? vt.top(m) : vt.top) || 0),
                        (T =
                            (wt.isFunction(vt.bottom)
                                ? vt.bottom(m)
                                : vt.bottom) || 0);
                }
                function X() {
                ...
                function Y() {
                    a &&
                        ...
                        f.css(A),
                        m.css("minWidth", U),
                        m.css("minWidth", Ht(m, F)));
                }
                var B = !1;
                function K(t) {
                    B !== t &&
                        ((B = t), m.triggerHandler("floatThead", [t, E]));
                }
                function $(t) {
                    z !== t &&
                        ((z = t),
                        E.css({ position: z ? "absolute" : "fixed" }));
                }
                function J() {
                    var l,
                        s = (function () {
                            var t,
                                e = d.find(vt.headerCellSelector);
                            if (
                                (p
                                    ? (t = u.find(h).length)
                                    : ((t = 0),
                                ...
                                for (var r = 0; r < t; r++) {
                                    ...
                                    a.setAttribute(
                                        "aria-label",
                                        vt.ariaLabel(m, e.eq(r), r)
                                    ),
                                        (a.className = "floatThead-col"),
                                        w[0].appendChild(a),
                                        o.push("<col/>"),
                                        n.push(
                                            bt("<fthtd>").css({
                    ...
                    return function () {
                        ...
                        var e,
                            ...
                            a =
                                ...
                                (n = F),
                                (r = mt),
                                Ct ? n : r ? vt.getSizingRow(e, o, n) : o);
                        if (a.length === s && 0 < s) {
                            if (!p)
                                for (l = 0; l < s; l++)
                                    k.eq(l).css("width", "");
                            ...
                            for (l = 0; l < s; l++)
                                D.eq(l).width(i[l]), k.eq(l).width(i[l]);
                            X();
                ...
                function tt() {
                    ...
                    return function (t) {
                        ...
                        if ("windowScroll" === t)
                            (v = xt.scrollTop()), (b = xt.scrollLeft());
                ...
                function ot() {
                    if (x.length)
                        if (
                            vt.support &&
                            vt.support.perfectScrollbar &&
                            x.data().perfectScrollbar
                        )
                            C = { horizontal: 0, vertical: 0 };
                        else {
                            if ("scroll" === x.css("overflow-x"))
                                C.horizontal = It;
                            else {
                                var t = x.width(),
                                    e = Ht(m, F),
                ...
                if (
                    ...
                    !Lt
                        ? (pt = window.matchMedia("print")).addListener(ut)
                        : (xt.on("fth-beforeprint", ft),
                          xt.on("fth-afterprint", ct)),
                    L
                        ? z
                            ? x.on(G("scroll"), st)
                            : (x.on(G("scroll"), st), xt.on(G("scroll"), lt))
                        : (S.on(G("scroll"), st), xt.on(G("scroll"), lt)),
                    xt.on(G("load"), dt),
                    (function (t, e) {
                        if (8 === mt) {
                            var o = xt.width(),
                    ...
                    m.on("reflow", dt),
                    vt.support &&
                        vt.support.datatables &&
                        (function (t) {
                            if (t.dataTableSettings)
                                for (
                                    var e = 0;
                                    e < t.dataTableSettings.length;
                                    e++
                                ) {
                        ...
                        m.on("filter", dt).on("sort", dt).on("page", dt),
                    vt.support &&
                        vt.support.bootstrap &&
                        xt.on(G("shown.bs.tab"), dt),
                    vt.support &&
                        vt.support.jqueryUI &&
                        xt.on(G("tabsactivate"), dt),
                    o)
                ) {
                    var ht = null;
                    wt.isFunction(vt.autoReflow) && (ht = vt.autoReflow(m, x)),
                        ht || (ht = x.length ? x[0] : m[0]),
                ...
                m.data("floatThead-attached", {
                    destroy: function () {
                        ...
                        return (
                            ...
                            u.remove(),
                            Ct && l.remove(),
                            b.parent().length && b.replaceWith(d),
                            K(!1),
                            o && (n.disconnect(), (n = null)),
                            m.off("reflow reflowed"),
                            x.off(t),
                            S.off(t),
                            q && (x.length ? x.unwrap() : m.unwrap()),
                            L
                                ? x.data("floatThead-containerWrap", !1)
                                : m.data("floatThead-containerWrap", !1),
                            m.css("minWidth", U),
                            E.remove(),
                            m.data("floatThead-attached", !1),
                            xt.off(t),
                            xt.off("fth-beforeprint fth-afterprint"),
                            pt && pt.removeListener(ut),
                            (ft = ct = function () {}),
                            function () {
                    ...
                    getRowGroups: function () {
                        return a
                            ? E.find(">table>thead").add(
                                  m.children("tbody,tfoot")
                              )
                            : m.children("thead,tbody,tfoot");
                    },
                });
            }),
            this
