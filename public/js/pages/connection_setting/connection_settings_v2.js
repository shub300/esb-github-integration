        ...
        if (auth_type == "oAuth") {
            ...
            if (url) {
                ...
                $.get(url, function(data) {
                    ...
                    if($("#p1_connection_form .auth_platform_name").val() == 'extensivbillingmanager' && $("#p1_connection_form .allow_direct_connection").val() == 1){
                        $('#p1_conn_section').hide();
                        connectExtensivBillingManagerAccount();
                    }
                });
            } else {
                $('#p1_conn_section').hide();
