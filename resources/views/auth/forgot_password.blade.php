...
<head>
    ...
    <title>{{ config('org_details.name') }} | Forgot Password</title>
                ...
                <div class="col-xl-6 col-lg-6 col-12 fxt-bg-color">
                    <div class="fxt-content">
                        <div class="fxt-header">
                            ...
                            <br/><br/>
                            @endif
                            <h2 style="margin-bottom: 25px;">Forgot Password</h2>
                        </div>
                        <div class="fxt-form">
                            ...
                            @endif
                            <form method="POST" id="frmSubmit" autocomplete="off" data-toggle="validator" role="form" action="{{ url('password/reset') }}">
                                {{ csrf_field() }}
                                <div class="form-group">
                                  
                                        <input type="email" name="email" id="email1" data-error="Your email address is invalid" required autocomplete="off" placeholder="Enter your email" class="form-control input-sm @error('email') is-invalid @enderror">
                                        <div class="help-block with-errors"></div>
                                  
                                </div>
                                <div class="form-group">
                                    <div class="fxt-transformY-50 fxt-transition-delay-4">
                                        <button type="submit" class="fxt-btn-fill btnSubmit">Reset Password</button>
                                    </div>
                                </div>
                            </form>
                        </div>
