...
<div class="lockscreen-wrapper">
    ...
    <div class="container error-page">
        <h2 class="headline text-danger" style="text-align: center; margin-left:-15px;">500</h2>
        <div class="error-content">
            <h3><i class="fas fa-exclamation-triangle text-danger" style="padding-top: 20px"></i> Oops! Something went wrong.</h3>
            <p>
