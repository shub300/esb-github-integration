...
https://pixinvent.com/demo/vuexy-html-bootstrap-admin-template/html/ltr/vertical-menu-template/page-auth-register-v1.html
    ...
    <div class="auth-inner py-2">
      ...
      <div class="card mb-0">
        <div class="card-body">
          ...
          <form class="auth-register-form mt-2" action="index.html" method="POST" novalidate="novalidate">
            <div class="mb-1">
