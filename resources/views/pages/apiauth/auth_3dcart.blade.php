		...
		<div class="card mb-0">
			<div class="card-body">
				<a href="#" class="brand-logo">
					<img class="icon" src="{{env('CONTENT_SERVER_PATH')}}{{'/public/esb_asset/brand_icons/3dcart.png'}}" width="30%" height="30%">
				</a>
				<h4 class="card-title mb-1 text-center">Enter Authentication Details</h4>
				@if($platform=='3dcart')
				<form method="POST" class="3dcart_connect_form" action="{{route('Connect3dcartOauth')}}" onsubmit="return validateForm('3dcart');">
					@csrf
					<div class="mb-1">
						<label class="my-label">Store URL</label>
						<input type="text" class="form-control" id="store_url" name="store_url" placeholder="Example: www.domain.xyz">
...
<script src="{{asset('public/js/pages/auth_3dcart.js')}}"></script>
@endpush