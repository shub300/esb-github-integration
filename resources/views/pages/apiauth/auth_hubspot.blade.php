                ...
                <div class="card mb-0">
                    <div class="card-body">
                        <div class="col-sm-12 align-self-center text-center">
                            <img class="icon mb-1" width="30%" height="30%" src="{{env('CONTENT_SERVER_PATH').'/public/esb_asset/brand_icons/hubspot.png'}}">
                            <h4 class="card-title mb-1 text-center">
                                Enter Authentication Details
                            </h4>
                        </div>
                        <form method="POST" action="{{route('hubspot.connect')}}" onsubmit="return validateHubSpotForm();" autocomplete="off">
                            @csrf
                            ...
                            <div class="row d-none">
                                <div class="col-md-12">
                                    <label class="my-label">App ID</label>
                                    <input type="text" class="form-control" id="access_key" name="access_key" placeholder="App ID">
                                    <small class="field_error">Field value is invalid!</small>
                                </div>
                            </div>
                            <div class="row d-none">
                                <div class="col-md-12">
                                    <label class="my-label">hAPIKey</label>
                                    <input type="text" class="form-control" id="secret_key" name="secret_key" placeholder="HubSpot API Key">
                                    <small class="field_error">Field value is invalid!</small>
                                </div>
                            </div>
                            <div class="row d-none">
