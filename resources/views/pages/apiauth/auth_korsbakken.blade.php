    ...
    <div class="auth-inner py-2">
        ...
        <div class="card mb-0">
            <div class="card-body">
                ...
                <form method="POST" action="{{url('/ConnectKorsbakken')}}"
                    onsubmit="return validateKorsbakkenForm('korsbakken');">
                    @csrf
                    <div class="mb-1">
                        <label class="my-label">Friendly Account Name&nbsp;<span class="text-danger">*</span></label>
                        <input type="text" class="form-control" id="account_name" name="account_name"
                            placeholder="Enter a friendly account name">
                        <span class="field_error">@lang('tagscript.error_msg')</span>
                    </div>

                    <div class="mb-1">
                        <label class="my-label">Transfer Protocol Type&nbsp;<span class="text-danger">*</span></label>
...
<script>
    ...
    function validateKorsbakkenForm(platform) {
        valid = true;
        $('.field_error').hide();
        if (!checkvalue($('#protocol'))) {
            showErrorAndFocus($('#protocol'));
            valid = false;
        }
