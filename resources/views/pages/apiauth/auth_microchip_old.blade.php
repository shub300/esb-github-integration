            ...
            <div class="col-sm-8">
                ...
                <form method="POST" class="microchip_connect_form">
                    ...
                    <div class="mb-1">
                        ...
                        <input type="text" class="form-control" id="microchip_ftp_domain" name="microchip_ftp_domain" placeholder="FTP Domain" />
                        <small class="err_mgs">@lang('tagscript.error_msg')</small>
                    </div>
                    <div class="mb-1">
                        <label class="my-label">FTP Username<span class="required">*</span></label>
                        <input type="text" class="form-control" id="microchip_ftp_username" name="microchip_ftp_username" placeholder="FTP Username"/>
                        <small class="err_mgs">@lang('tagscript.error_msg')</small>
                    </div>
                    <div class="mb-1">
                        <label class="my-label">FTP Password<span class="required">*</span></label>
                        <input type="text" class="form-control" id="microchip_ftp_password" name="microchip_ftp_password" placeholder="FTP Password"/>
                        <small class="err_mgs">@lang('tagscript.error_msg')</small>
                    </div>
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				<div class="mb-1">
					...
					<h6><b>FTP Domain:&nbsp;</b><small id="mdlmicrochip_ftp_domain"></small></h6>
				</div>
			</div>
