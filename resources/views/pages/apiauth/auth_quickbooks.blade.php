        ...
        <div class="card mb-0">
            <div class="card-body">
                <div class="brand-logo">
                    <img class="icon" src="{{env('CONTENT_SERVER_PATH')}}{{'/public/esb_asset/brand_icons/quickbooks.png'}}" width="30%" height="30%">
				</div>
                ...
                <form method="POST" action="{{route('quickbooks.connect')}}" onsubmit="return validateForm();">
                    @csrf
                    @include('flash.flash_message')
                    <div class="mb-1">
                        <label class="my-label">Account Nick Name</label>
                        <input type="text" class="form-control" id="account_name" name="account_name" placeholder="Account Nick Name">
                        <small class="field_error" style="color:red !important">This account nick name field is required!</small>
					</div>
