...
<style>
	...
	.auth-wrapper.auth-v1 .auth-inner {position: relative; max-width: 400px}
		...
		<div class="card mb-0">
			<div class="card-body">
				<a href="#" class="brand-logo">
					<img class="icon" src="{{env('CONTENT_SERVER_PATH')}}{{'/public/esb_asset/brand_icons/shipbob.png'}}" width="30%" height="30%">
				</a>
				<h4 class="card-title mb-1 text-center">Enter Authentication Details</h4>
				@if($platform=='shipbob')
				<form method="POST" class="shipbob_connect_form" action="{{route('ConnectShipBobOauth')}}" onsubmit="return validateForm('shipbob');">
					@csrf
					{{-- <div class="mb-1">
						<label class="my-label">Client ID<span class="required">*</span></label>
						<input type="text" class="form-control" id="shipbob_client_id" name="shipbob_client_id" placeholder="Client ID">
						<span class="field_error">Field value is required</span>
					</div>

					<div class="mb-1">
						<label class="my-label">Client Secret<span class="required">*</span></label>
						<input type="text" class="form-control" id="shipbob_client_secret" name="shipbob_client_secret" placeholder="Client Secret">
						<span class="field_error">Field value is required</span>
					</div> --}}

					<div class="mb-1">
						<label class="my-label">Account Name<span class="required">*</span></label>
						<input type="text" class="form-control" id="shipbob_account_name" name="shipbob_account_name" placeholder="Account Name">
...
<script src="{{asset('public/js/pages/auth_shipbob.js')}}"></script>
@endpush