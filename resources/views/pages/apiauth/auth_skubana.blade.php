        ...
        <div class="card mb-0">
            <div class="card-body">
                <div class="brand-logo">
                    <img class="icon" src="{{env('CONTENT_SERVER_PATH')}}{{'/public/esb_asset/brand_icons/skubana.jpg'}}" width="30%" height="30%">
                </div>
                ...
                <form method="POST" action="{{route('skubana.connect')}}" onsubmit="return validateForm();">
                    @csrf
                    ...
                    <div class="mb-1">
                        ...
                        <small class="field_error" style="color:red !important">This account name field is required!</small>
                    </div>
