        ...
        <div class="card mb-0">
            <div class="card-body">
                <div class="brand-logo">
					<img class="icon" src="{{env('CONTENT_SERVER_PATH')}}{{'/public/esb_asset/brand_icons/smartsheet.jpg'}}" width="30%" height="30%">
				</div>
				
                <h4 class="card-title mb-1 text-center">Enter Authentication Details</h4>
                
                <form method="POST" action="{{route('ConnectSmartsheetAuth')}}" onsubmit="return validateForm('smartsheet');">
                    @csrf
