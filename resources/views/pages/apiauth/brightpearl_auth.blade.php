        ...
        <div class="card mb-0">
            <div class="card-body">
                ...
                <div class="brand-logo">
                        ...
                        <img class="icon" src="{{env('CONTENT_SERVER_PATH')}}{{'/public/esb_asset/brand_icons/brightpearl.jpg'}}" width="30%" height="30%">
                ...
                <form method="POST" action="{{route('brightpearl.connect')}}" onsubmit="return validateForm('brightpearl');">
                    @csrf
