...
<div class="auth-wrapper auth-v1 px-2">
    <div class="auth-inner py-2">
        ...
        <div class="card mb-0">
            <div class="card-body">
                @if($platform=='brodrenedahl')
                <div class="brand-logo">



                        <img class="icon" src="{{env('CONTENT_SERVER_PATH')}}{{'/public/esb_asset/brand_icons/brodrenedahl.png'}}" width="30%" height="30%">
                ...
                <form method="POST" action="{{route('brodrene.connect')}}"  onsubmit="return validateForm('brodrenedahl');">
                    @csrf
