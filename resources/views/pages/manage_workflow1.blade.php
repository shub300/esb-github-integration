...
<div class="customizer d-md-block">
    ...
    <!-- Customizer header -->
        <div class="customizer-header px-2 pt-1 pb-0 position-relative">
          <h4 class="mb-0">Workflow Customizer</h4>
          <p class="m-0">Customize & Setup App Workflow</p>
          ...
          <div class="row">
              <div class="col-12"> 
                  ...
                  <select class="form-control wf-select" id="select-app-pos">
                      <option value="1" class="app-option">Source Platform </option>
                      <option value="2" class="app-option">Destination Platform</option>
                  </select>
                  ...
                  <div class="select-item mb-2 " >
                    ...
                    <div class="search-form" style="position: relative;">
                      ...
                      <div class="search-item ">
                        <span class="icon"><img src="{{asset('public/esb_asset/assets/images/icons/g-sheet.png')}}" /></span> <span class='text'>Google Sheet</span> <a class="remove-select" href="javascript:void(0);"><i data-feather="x"></i></a>
                     </div> --}}
                     <select data-placeholder="Select an app..." class="from-platform form-control wf-select" id="from-platform">
                        <option value="" data-icon="{{asset('public/esb_asset/assets/images/svg/search.png')}}"  selected disabled>Select an action </option>
                        {!!$platforms['options']!!}
                    </select>
                    </div>
                  ...
                  <div class="serach-item-options" >
                    <ul class="serach-list"> 
                      <li class="search-item" data-id="">
                        <span class="icon"><img src="{{asset('public/esb_asset/assets/images/icons/g-sheet.png')}}" /></span> <span class='text'>Google Sheet</span>
                      </li>
                      <li class="search-item" data-id="">
                        <span class="icon"><img src="{{asset('public/esb_asset/assets/images/icons/g-contact.png')}}" /></span> <span class='text'>Google Contact</span>
                      </li>
                      <li class="search-item" data-id="">
                        <span class="icon"><img src="{{asset('public/esb_asset/assets/images/icons/g-mail.png')}}" /></span> <span class='text'>Gmail</span>
                      </li>
                      <li class="search-item" data-id="">
                        <span class="icon"><img src="{{asset('public/esb_asset/assets/images/icons/g-form.png')}}" /></span> <span class='text'>Google From</span>
                      </li>
                      <li class="search-item" data-id="">
                        <span class="icon"><img src="{{asset('public/esb_asset/assets/images/icons/g-drive.png')}}" /></span> <span class='text'>Google Drive</span>
                      </li>
                      <li class="search-item" data-id="">
                        <span class="icon"><img src="{{asset('public/esb_asset/assets/images/icons/g-mail.png')}}" /></span> <span class='text'>Gmail</span>
                      </li>
                      <li class="search-item" data-id="">
                        <span class="icon"><img src="{{asset('public/esb_asset/assets/images/icons/g-calender.png')}}" /></span> <span class='text'>Google Calender</span>
                      </li>
                      <li class="search-item" data-id="">
                        <span class="icon"><img src="{{asset('public/esb_asset/assets/images/icons/g-slide.png')}}" /></span> <span class='text'>Google Slide</span>
                      </li>
                    </ul>
                  </div>
              </div>
                  ...
                  <div class="more-fileds account-wrapper w-100">
                      <div class="select-item mb-2 " >
                        ...
                        <select data-placeholder="Select an app..." class="form-control " id="appOneAccount">
                            <option value=""  data-icon="{{asset('public/esb_asset/assets/images/search.png')}}" selected >Select an Account </option>
                            <option value="Google Calender" data-icon="{{asset('public/esb_asset/assets/images/g-calender.png')}}" >Google Calender </option>
                            <option value="Google Sheet" data-icon="{{asset('public/esb_asset/assets/images/g-sheet.png')}}">Google Sheet</option>
                            <option value="" data-icon="{{asset('public/esb_asset/assets/images/g-sheet.png')}}">Add New Account</option>
                        </select>
                      </div>
                  </div>
              </div>
              ...
              <div class="mySearch col-12 ">
                  <div class="select-item mb-2 " >
                    ...
                    <div class="search-form" style="position: relative;">
                     ...
                     <select data-placeholder="Select an app..." class="to-platform form-control wf-select" id="to-platform">
                        <option value="" data-icon="{{asset('public/esb_asset/assets/images/svg/search.png')}}"  selected disabled>Select an action </option>
                        {!!$platforms['options']!!}
                    </select>
                    </div>
       ...
       <!-- <hr /> 
        ...
        <div class="customizer-menu px-2">
          <div id="customizer-menu-collapsible" class="d-flex">
            <p class="font-weight-bold mr-auto m-0">ESB Status </p>
